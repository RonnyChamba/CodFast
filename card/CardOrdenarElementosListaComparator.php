...
<div class="card">
    <div class="card__img">
        ...
        include ('./fragmentos/'.$ordenarElementosComparator);
        $nombreArchivo = 'card/CardOrdenarElementosListaComparator.php';
        ?>
    ...
    <div class="card__descripcion">
        ...
        <h2 class="card__subtitulo">Ordenar elementos de una lista, comparator</h2>
    </div>
</div>